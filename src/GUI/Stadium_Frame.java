...
public class Stadium_Frame extends javax.swing.JFrame {
   ...
   private Object[][] getStadium() throws Exception{
    ...
    private void initComponents() {
        ...
        jLabel_leagueName.setText("stadium");
    ...
    private void jButton_DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_DeleteActionPerformed
        ...
        try{  
            ...
            int stadiumID =  Integer.parseInt(teamsList[row][2].toString()) ;
            Statement stmt=con.createStatement();  
            int rs=stmt.executeUpdate("DELETE from stadium where ID =" + stadiumID);
            con.close();
